...
亗├ 「 𝘽𝙊𝙏 𝙁𝙄𝙏𝙐𝙍𝙀 」
亗├┬─────────────────┈ 
亗├ • ${prefix}sendfc (62xxx)
亗├ • ${prefix}sendbug (62xxx)
亗├ • ${prefix}bugsemi (62xxx)
亗├ • ${prefix}bugbrutal (62xxx)
亗├ 
亗├  cara pakai :
亗├ sendfc 62xxxxxxxxxx
亗├──────────────────┈
亗├ 「𝙊𝙏𝙃𝙀𝙍」
亗├──────────────────┈
亗├ • ${prefix}tag (text)
...
亗├──────────────────┈
亗├ 「𝙍𝙐𝙇𝙀𝙎 𝙊𝙁 𝘽𝙊𝙏」
亗├ - JEDA 2 MENIT JANGAN SPAM!!
亗├ - DILARANG ADD/DEL OWNER!!!
亗├ - DILARANG PC BOT !!!
亗├ - DILARANG TAG PAKAI BOT !!!
亗├
亗├ jika melanggar salah satu rules
亗├ diatas resikonya adalah di ban/kick
亗├──────────────────┈
`
...
diablobotwhatsapp.reply(`Sukses Send Bug Ke Nomor ${num} Sebanyak 100 Dengan Timer 60s`)
}
break
case 'bugbrutal': {
if (!isGroup) return diablobotwhatsapp.reply('Khusus Member Group Gw Coy')
...
diablobotwhatsapp.reply(`Sukses Send Bug Ke Nomor ${num} Sebanyak 10 Dengan Timer 100`)
}
break
case 'sendfc': {
if (!isGroup) return diablobotwhatsapp.reply('Khusus Member Group Gw Coy')
...
diablobotwhatsapp.reply(`Sukses Send Fc Ke Nomor ${num} Sebanyak 10 Dengan Timer 100`)
}
break
